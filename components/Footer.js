...
export default function Footer() {
  return (
    <footer className="bg-chocolate-brown text-white/80">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Tagline */}
          <p className="text-white/50 font-medium text-sm mb-6 max-w-xs">
            Rumahnya Camilan Manis &amp; Momen Ceria 💛
          </p>
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 rounded-xl text-sm font-semibold transition-colors duration-200"
